...
|---|---|---|---|
| [`shark-signal`](shark-signal/) | 1.0.1 | [shark-signal.skill](shark-signal.skill) | Send a JSON POST to a SharkSignals signal endpoint (TradingView-style webhook) for testing the signal pipeline. |
